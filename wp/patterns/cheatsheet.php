      ...
      <ul class="list-unstyled">
        <li class="my-2">
            <button type="button" class="btn d-inline-flex align-items-center collapsed border-0"
                data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#partials-collapse"
                aria-controls="partials-collapse">Partials</button>
            <ul class="list-unstyled ps-3 collapse" id="partials-collapse">
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/album">album</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/badges">badges</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/blog">blog</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/breadcrumbs">breadcrumbs</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/buttons">buttons</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/carousel">carousel</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/cheatsheet">cheatsheet</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/checkout-form">checkout-form</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/cover">cover</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/custom-jumbotron">jumbotron</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/dashboard">dashboard</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/dropdowns">dropdowns</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/features">features</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/fixed-navbar">fixed-navbar</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/footers">footers</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/grid-template">grid template</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/headers">headers</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/heros">heros</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/index">index</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/jumbotrons">jumbotrons</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/listgroups">listgroups</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/masonry">masonry</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/modals">modals</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/navbar-bottom">bottom</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/navbars">navbars</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/navs">navs</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/offcanvas-navbar">offcanvas navbar</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/priving">pricing</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/product-example">example</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/sidebars">sidebars</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/signin">signin</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/sticky-footer-fixed-navbar">footer fixed navbar</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/sticky-footer">sticky footer</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/top-navbar">top navbar</a></li>
                <li><a class="d-inline-flex align-items-center rounded text-decoration-none"
                        href="./bootstrap/topbar">topbar</a></li>
            </ul>
        </li>
        <li class="my-2">
          <button type="button" class="btn d-inline-flex align-items-center collapsed border-0"
        ...
        <li class="my-2">
          ...
          <ul class="list-unstyled ps-3 collapse" id="forms-collapse">
            ...
            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#disabled-forms">Disabled
                forms</a></li>
        ...
        <li class="my-2">
          ...
          <ul class="list-unstyled ps-3 collapse" id="components-collapse">
            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#accordion">Accordion</a>
            </li>
            ...
            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#dropdowns">Dropdowns</a>
            </li>
            ...
            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#scrollspy">Scrollspy</a>
            </li>
  ...
  <div class="bd-cheatsheet container-fluid bg-body">
    <section id="content">
      ...
      <article class="my-3" id="typography">
        <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2 pt-5">
          <h3>Typography</h3>
